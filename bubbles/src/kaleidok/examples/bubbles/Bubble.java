...
import static kaleidok.examples.bubbles.util.Math.between;
import static kaleidok.examples.bubbles.util.Math.square;
import static kaleidok.examples.bubbles.util.Math.clamp;
